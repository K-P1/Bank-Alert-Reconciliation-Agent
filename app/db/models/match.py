...
class Match(Base):
    ...
    matched: Mapped[bool] = mapped_column(
        default=False, nullable=False, index=True, comment="Whether a match was found"
    )
    ...
    reviewed_at: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True), nullable=True, comment="When this match was reviewed"
    )
    review_notes: Mapped[Optional[str]] = mapped_column(
        Text, nullable=True, comment="Notes from manual review"
    )
