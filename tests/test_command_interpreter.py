...
import pytest
from app.a2a.command_interpreter import CommandInterpreter, CommandMatch
...
class TestCommandInterpreter:
    ...
    def test_register_command(self, interpreter):
        ...
        assert len(interpreter._compiled_patterns["test_reconcile"]) == 5  # Updated from 3 to 5
    ...
    def test_confidence_scoring(self, interpreter):
        ...
        match2 = interpreter.interpret("I would like to reconcile all the things please thank you")
